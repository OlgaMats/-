...
- Самоизоляция в связи с коронавирусом, то есть люди не могут без проблем прийти на выставку или вход разрешен только для тех, кто имеет сертификат о вакцинации;

- Экспонат не подходит под тематику выставки;

- Нарушена целостность экспонатов;

- Неверный выводов о количестве целевой аудитории на выставке;
